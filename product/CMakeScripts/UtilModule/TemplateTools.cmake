...
function(generate_from_template)
    ...
    if (DEFINED GFT_GENERATE_TARGET)
        message(STATUS "generate coden target:${GFT_GENERATE_TARGET}")
        add_custom_target(${GFT_GENERATE_TARGET} ALL DEPENDS ${GFT_OUTPUT_FILE})
        set_target_properties(${GFT_GENERATE_TARGET} PROPERTIES FOLDER codegen)
    endif()

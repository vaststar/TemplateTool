...
function(BuildQtModule)
        ...
        set(multiValueArgs TARGET_SOURCE TARGET_PRIVATE_DEPENDENICES TARGET_PUBLIC_DEPENDENICES 
                           ...
                           TARGET_DEFINITIONS
                           INSTALL_PUBLIC_HEADER INSTALL_PUBLIC_HEADER_DIR
                           IDE_FOLDER
        ...
        message(STATUS "INSTALL_PUBLIC_HEADER_DIR: ${MODULE_INSTALL_PUBLIC_HEADER_DIR}")
        ...
        LinkTargetIncludeDirectories(
            ...
            TARGET_INCLUDE_DIRECTORIES_BUILD_INTERFACE ${MODULE_PUBLIC_BUILD_INTERFACE_FOLDER}
            TARGET_INCLUDE_DIRECTORIES_INSTALL_INTERFACE ${MODULE_PUBLIC_INSTALL_INTERFACE_FOLDER}
            TARGET_INCLUDE_DIRECTORIES_PRIVATE ${MODULE_PRIVATE_BUILD_FOLDER}
        )
        ...
        if (DEFINED MODULE_INSTALL_PUBLIC_HEADER_DIR)
            set(INSTALL_HEADER_PATH ${MODULE_MODULE_NAME}/${MODULE_INSTALL_PUBLIC_HEADER_DIR})
        else()
            set(INSTALL_HEADER_PATH ${MODULE_MODULE_NAME}/include)
        endif()
        install(TARGETS ${MODULE_MODULE_NAME} 
            ...
            PUBLIC_HEADER DESTINATION ${INSTALL_HEADER_PATH}
        )

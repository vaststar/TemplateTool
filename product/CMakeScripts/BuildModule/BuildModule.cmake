...
function(BuildModule)
        ...
        set(oneValueArg MODULE_NAME IDE_FOLDER TARGET_SOURCE_HEADER_BASE_DIR)
        set(multiValueArgs
            TARGET_SOURCE_PRIVATE TARGET_SOURCE_PUBLIC_HEADER
            TARGET_ADD_LINK_LIBRARY_PRIVATE TARGET_ADD_LINK_LIBRARY_PUBLIC
        ...
        if(MODULE_TARGET_ADD_LINK_LIBRARY_PRIVATE)
            ...
            target_link_libraries(${MODULE_MODULE_NAME}  PRIVATE $<BUILD_INTERFACE:${MODULE_TARGET_ADD_LINK_LIBRARY_PRIVATE}>)
        endif()
        ...
        if (MODULE_TARGET_ADD_LINK_LIBRARY_PUBLIC)
            ...
            target_link_libraries(${MODULE_MODULE_NAME} PUBLIC $<BUILD_INTERFACE:${MODULE_TARGET_ADD_LINK_LIBRARY_PUBLIC}>)
        endif()

 ...
 */
enum class ToolPanelType : uint8_t
{
    None = 0,           // 无面板（分类节点）
    Base64,             // Base64 编解码
    Json,               // JSON 格式化
...
/**
 * @brief 工具节点数据. parentId == "" 表示节点挂在 virtual root 下.
 */
struct TOOLS_VIEW_MODEL_TYPES_API ToolNodeData
{
    std::string nodeId;
    std::string parentId;
    std::string title;
 ...
 * @brief 工具树节点接口
 */
class TOOLS_VIEW_MODEL_TYPES_API IToolsTreeNode
{
public:
 ...
 * @brief 工具树接口
 */
class TOOLS_VIEW_MODEL_TYPES_API IToolsTree
{
public:

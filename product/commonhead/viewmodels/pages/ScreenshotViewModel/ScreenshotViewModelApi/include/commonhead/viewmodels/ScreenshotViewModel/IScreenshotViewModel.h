...
class IScreenshotViewModelCallback {
public:
...
public:
    ...
    IScreenshotViewModel(const IScreenshotViewModel&) = delete;
    IScreenshotViewModel(IScreenshotViewModel&&) = delete;
    IScreenshotViewModel& operator=(const IScreenshotViewModel&) = delete;
    IScreenshotViewModel& operator=(IScreenshotViewModel&&) = delete;
    virtual ~IScreenshotViewModel() = default;

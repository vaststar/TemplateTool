...
/* This is not a valid API, used for test purposes only */
void EVP_PKEY_test_set1_EC_KEY(EVP_PKEY *pkey, EC_KEY *ec2);
...
/* EC method flags exposed to apps */
#define EC_FLAGS_FIPS_METHOD    0x400
...
void EC_KEY_METHOD_set_flags(EC_KEY_METHOD *meth, int flags);
int EC_KEY_METHOD_get_flags(EC_KEY_METHOD *meth);

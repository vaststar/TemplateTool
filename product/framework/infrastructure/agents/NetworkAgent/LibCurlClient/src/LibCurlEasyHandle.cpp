...
{
public:
    DataPrivate(ucf::agents::network::http::HttpHeaderCallback headerCallback, ucf::agents::network::http::HttpBodyCallback bodyCallback, ucf::agents::network::http::HttpCompletionCallback completionCallback);
    ~DataPrivate();

    CURL* getHandle();

    ucf::agents::network::http::HttpResponseMetrics getResponseMetrics() const;

    const ucf::agents::network::http::HttpHeaderCallback& getHeaderCallback() const {return mHeaderCallback;}
    const ucf::agents::network::http::HttpBodyCallback& getBodyCallback() const {return mBodyCallback;}
    const ucf::agents::network::http::HttpCompletionCallback& getCompletionCallback() const {return mCompletionCallback;}
    ...
    int setHttpMethod(ucf::agents::network::http::HTTPMethod method);
    int setURI(const std::string& uri);
    int setHeaders(const ucf::agents::network::http::NetworkHttpHeaders& headers);
    ...
    ucf::agents::network::http::NetworkHttpHeaders getResponseHeader() const;
...
private:
    ...
    CURLU* mUrl;
    curl_slist* mHeaders;
    ucf::agents::network::http::HttpHeaderCallback mHeaderCallback;
    ucf::agents::network::http::HttpBodyCallback mBodyCallback;
    ucf::agents::network::http::HttpCompletionCallback mCompletionCallback;
    std::string mTrackingId;
    std::string mRequestId;

    ucf::agents::network::http::NetworkHttpHeaders mResponseHeader;
    std::shared_ptr<PayloadData> mPayloadData;
};

LibCurlEasyHandle::DataPrivate::DataPrivate(ucf::agents::network::http::HttpHeaderCallback headerCallback, ucf::agents::network::http::HttpBodyCallback bodyCallback, ucf::agents::network::http::HttpCompletionCallback completionCallback)
...
ucf::agents::network::http::HttpResponseMetrics LibCurlEasyHandle::DataPrivate::getResponseMetrics() const
{
...
int LibCurlEasyHandle::DataPrivate::setHttpMethod(ucf::agents::network::http::HTTPMethod method)
{
    int result = { 0 };
    switch (method)
    {
        case ucf::agents::network::http::HTTPMethod::GET:
            result = setOption(CURLOPT_HTTPGET, 1L);
            break;
        case ucf::agents::network::http::HTTPMethod::POST:
            setOption(CURLOPT_POST, 1L);
            result = setOption(CURLOPT_POSTFIELDS, nullptr);
            break;
        case ucf::agents::network::http::HTTPMethod::HEAD:
            setOption(CURLOPT_NOBODY, 1L);
            result = setOption(CURLOPT_CUSTOMREQUEST, "HEAD");
            break;
        case ucf::agents::network::http::HTTPMethod::PUT:
            setOption(CURLOPT_CUSTOMREQUEST, "PUT");
            result = setOption(CURLOPT_POSTFIELDS, nullptr);
            break;
        case ucf::agents::network::http::HTTPMethod::DEL:
            result = setOption(CURLOPT_CUSTOMREQUEST, "DELETE");
            break;
        case ucf::agents::network::http::HTTPMethod::PATCH:
            result = setOption(CURLOPT_CUSTOMREQUEST, "PATCH");
            break;
        case ucf::agents::network::http::HTTPMethod::OPTIONS:
...
int LibCurlEasyHandle::DataPrivate::setHeaders(const ucf::agents::network::http::NetworkHttpHeaders& headers)
{
...
ucf::agents::network::http::NetworkHttpHeaders LibCurlEasyHandle::DataPrivate::getResponseHeader() const
{
...
/////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
LibCurlEasyHandle::LibCurlEasyHandle(ucf::agents::network::http::HttpHeaderCallback headerCallback, ucf::agents::network::http::HttpBodyCallback bodyCallback, ucf::agents::network::http::HttpCompletionCallback completionCallback)
...
void LibCurlEasyHandle::setHttpMethod(ucf::agents::network::http::HTTPMethod method)
{
...
void LibCurlEasyHandle::setHeaders(const ucf::agents::network::http::NetworkHttpHeaders& headers)
{
...
void LibCurlEasyHandle::appendResponseBody(char *data, size_t size)
{
    ...
    {
        mDataPrivate->getBodyCallback()(ucf::agents::network::http::ByteBuffer(data, data + size), false);
    }
}
...
void LibCurlEasyHandle::setRequestDataBuffer(ucf::agents::network::http::ByteBufferPtr buffer, ucf::agents::network::http::UploadProgressFunction progressFunc)
{
    mDataPrivate->setPayloadData(std::make_shared<BufferPayloadData>(buffer, progressFunc));
}

void LibCurlEasyHandle::setRequestDataFile(const std::string& filePath, ucf::agents::network::http::UploadProgressFunction progressFunc)
{
...
void LibCurlEasyHandle::finishHandle(CURLcode code)
{
    ...
    if (code == CURLE_OK)
    {
        if (mDataPrivate->getBodyCallback() != nullptr)
        {
            ucf::agents::network::http::ByteBuffer emptyBuf;
...
ucf::agents::network::http::ResponseErrorStruct LibCurlEasyHandle::makeErrorData(CURLcode code)
{
    ucf::agents::network::http::ResponseErrorStruct errorStruct;
    ...
    case CURLE_RECV_ERROR:
        errorStruct.errorType = ucf::agents::network::http::ResponseErrorType::SocketError;
        break;
    ...
    case CURLE_PEER_FAILED_VERIFICATION:
        errorStruct.errorType = ucf::agents::network::http::ResponseErrorType::TLSError;
        break;
    ...
    case CURLE_ABORTED_BY_CALLBACK:
        ...
        break;
    default:
        errorStruct.errorType = ucf::agents::network::http::ResponseErrorType::UnHandledError;
        break;
    }
    return errorStruct;
}

...
///   <lib_dir>/../Resources/<addon>/<executable>  (macOS .app bundle)
///   <lib_dir>/<addon>/<executable>       (Windows/Linux build + install)
///   <lib_dir>/../<addon>/<executable>    (alternate sibling layout)

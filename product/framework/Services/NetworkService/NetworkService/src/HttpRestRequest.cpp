...
public:
    ...
    void setHeaders(const HttpRequestHeaders& headers){ mHeaders = headers;}
    HttpRequestHeaders getHeaders() const{ return mHeaders;}
...
HttpRestRequest::HttpRestRequest(const HTTPMethod& requestMethod, const std::string& uri, const HttpRequestHeaders& headers, const std::string& body, int timeoutSecs)
...
HttpRequestHeaders HttpRestRequest::getRequestHeaders() const
{

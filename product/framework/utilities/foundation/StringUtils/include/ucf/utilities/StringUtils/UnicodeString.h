...
#include <ucf/utilities/StringUtils/StringUtilsExport.h>
 ...
 * @endcode
 */
class STRING_UTILS_API UnicodeString final
{
public:
    // ==========================================
    // Constructors
    ...
    class STRING_UTILS_API ConstIterator
    {
    public:
...
/// Stream output
STRING_UTILS_API std::ostream& operator<<(std::ostream& os, const UnicodeString& str);

/// Concatenation operators
[[nodiscard]] STRING_UTILS_API UnicodeString operator+(const char* lhs, const UnicodeString& rhs);
[[nodiscard]] STRING_UTILS_API UnicodeString operator+(const std::string& lhs, const UnicodeString& rhs);

/// Comparison operators
[[nodiscard]] STRING_UTILS_API bool operator==(const std::string& lhs, const UnicodeString& rhs) noexcept;
[[nodiscard]] STRING_UTILS_API bool operator==(const char* lhs, const UnicodeString& rhs) noexcept;

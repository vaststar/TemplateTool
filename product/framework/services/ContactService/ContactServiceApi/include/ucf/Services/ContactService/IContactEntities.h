...
class IPersonContact: public IContact
{
public:
    enum class Gender {
        Unspecified = 0,
...
class IGroupContact: public IContact
{
public:
...
class IDepartmentGroup: public IGroupContact
{
public:
...
// Team-typed group.
class ITeamGroup: public IGroupContact
{
public:
...
class IFolderGroup: public IGroupContact
{
};

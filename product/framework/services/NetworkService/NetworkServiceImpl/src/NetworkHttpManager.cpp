...
public:
    DataPrivate();
    std::shared_ptr<ucf::infrastructure::network::http::INetworkHttpClient> getNetworkHttpClient() const;
private:
    std::shared_ptr<ucf::infrastructure::network::http::INetworkHttpClient> mNetworkHttpClient;
};

NetworkHttpManager::DataPrivate::DataPrivate()
    :mNetworkHttpClient(std::make_shared<ucf::infrastructure::network::libcurl::LibCurlClient>())
{

}

std::shared_ptr<ucf::infrastructure::network::http::INetworkHttpClient> NetworkHttpManager::DataPrivate::getNetworkHttpClient() const
{
...
//     SERVICE_LOG_DEBUG("test:" << s);
    ...
    auto curlHeaderCallback = [httpHandler, requestId, trackingId, this, weakThis = weak_from_this()](int statusCode, const ucf::infrastructure::network::http::NetworkHttpHeaders& headers, std::optional<ucf::infrastructure::network::http::ResponseErrorStruct> errorData) {
    ...
    auto curlBodyCallback = [httpHandler, requestId, trackingId, this, weakThis = weak_from_this()](const ucf::infrastructure::network::http::ByteBuffer& buffer, bool isFinished){
        RETURN_FROM_LAMBDA_IF_DEAD(weakThis);
    ...
    auto curlCompletionCallback = [httpHandler, requestId, trackingId, this, weakThis = weak_from_this()](const ucf::infrastructure::network::http::HttpResponseMetrics& metrics){
        RETURN_FROM_LAMBDA_IF_DEAD(weakThis);

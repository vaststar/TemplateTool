...
#include <commonHead/viewModels/JsonTreeViewModel/JsonTreeViewModelTypesExport.h>
 ...
 * @brief JSON 节点类型
 */
enum class JsonNodeType : std::uint8_t
{
    Object,         // 0
    Array,          // 1
    String,         // 2
 ...
 * @brief JSON 树节点数据
 */
struct JSON_TREE_VIEW_MODEL_TYPES_API JsonNodeData
{
 ...
 * @brief JSON 树节点接口
 */
class JSON_TREE_VIEW_MODEL_TYPES_API IJsonTreeNode
{
public:
 ...
 * @brief JSON 树接口
 */
class JSON_TREE_VIEW_MODEL_TYPES_API IJsonTree
{
public:

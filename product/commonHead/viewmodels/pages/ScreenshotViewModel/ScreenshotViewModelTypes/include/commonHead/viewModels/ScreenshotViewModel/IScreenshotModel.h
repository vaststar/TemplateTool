...
#include <commonHead/viewModels/ScreenshotViewModel/ScreenshotViewModelTypesExport.h>
...
struct SCREENSHOT_VIEW_MODEL_TYPES_API ScreenshotSettings {
...
struct SCREENSHOT_VIEW_MODEL_TYPES_API AnnotationData {
    int id = 0;
...
struct SCREENSHOT_VIEW_MODEL_TYPES_API DisplayInfoVM {
    int displayId = 0;
    std::string name;

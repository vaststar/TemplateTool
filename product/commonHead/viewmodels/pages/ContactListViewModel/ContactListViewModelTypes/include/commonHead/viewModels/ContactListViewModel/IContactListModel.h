#pragma once
#include <commonHead/viewModels/ContactListViewModel/ContactListViewModelTypesExport.h>
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API ContactNodeData
{
    std::string     id;
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API ContactRelationData
{
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API RemovedRelationInfo
{
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API PersonContactDetail
{
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API DepartmentGroupDetail
{
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API TeamGroupDetail
{
...
struct CONTACT_LIST_VIEW_MODEL_TYPES_API ContactDetail
{
    std::string     id;
    std::string     displayName;
...
class CONTACT_LIST_VIEW_MODEL_TYPES_API IContactTree
{
public:

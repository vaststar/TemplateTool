...
class IRecordingViewModelCallback {
public:
...
public:
    ...
    IRecordingViewModel(const IRecordingViewModel&) = delete;
    IRecordingViewModel(IRecordingViewModel&&) = delete;
    IRecordingViewModel& operator=(const IRecordingViewModel&) = delete;
    IRecordingViewModel& operator=(IRecordingViewModel&&) = delete;
    virtual ~IRecordingViewModel() = default;

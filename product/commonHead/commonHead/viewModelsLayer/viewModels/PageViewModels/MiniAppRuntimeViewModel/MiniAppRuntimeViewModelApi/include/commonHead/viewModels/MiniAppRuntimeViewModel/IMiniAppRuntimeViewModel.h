...
// framework headers.
class IMiniAppRuntimeViewModelCallback
{
public:
...
public:
    ...
    IMiniAppRuntimeViewModel(const IMiniAppRuntimeViewModel&) = delete;
    IMiniAppRuntimeViewModel(IMiniAppRuntimeViewModel&&) = delete;
    IMiniAppRuntimeViewModel& operator=(const IMiniAppRuntimeViewModel&) = delete;
    IMiniAppRuntimeViewModel& operator=(IMiniAppRuntimeViewModel&&) = delete;
    virtual ~IMiniAppRuntimeViewModel() = default;

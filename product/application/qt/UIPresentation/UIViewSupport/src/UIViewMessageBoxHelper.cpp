                                              ...
                                              MessageCallback onClosed)
{
    ...
    {
        UIVIEW_SUPPORT_LOG_WARN("UIViewMessageBoxHelper::showMessageAsync: no buttons; aborting");
    ...
    if (!factory)
    {
        UIVIEW_SUPPORT_LOG_WARN("UIViewMessageBoxHelper::showMessageAsync: no view factory");
        if (onClosed) onClosed({ -1, {} });
        return;
    }
    ...
    if (!window)
    {
        UIVIEW_SUPPORT_LOG_WARN("UIViewMessageBoxHelper::showMessageAsync: failed to create UTMessageDialog");
        if (onClosed) onClosed({ -1, {} });
        return;
    }
    ...
    if (!controller)
    {
        UIVIEW_SUPPORT_LOG_WARN("UIViewMessageBoxHelper::showMessageAsync: UTMessageDialog has no UTMessageDialogController");
        window->deleteLater();
        if (onClosed) onClosed({ -1, {} });
        return;
    }
